...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor execute npm install -g @yongkangc/happy-coder@latest',
    ...
    agentInput: {
        ...
        codexModel: {
            ...
            gpt51CodexMaxMedium: 'GPT-5.1 Codex Max (Médio)',
            gpt51CodexHigh: 'GPT-5.1 Codex (Alto)',
            gpt51CodexMedium: 'GPT-5.1 Codex (Médio)',
            gpt51CodexLow: 'GPT-5.1 Codex (Baixo)',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `happy daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g @yongkangc/happy-coder@latest`',
