...
export const en = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Please run npm install -g @yongkangc/happy-coder@latest',
    ...
    machine: {
        ...
        offlineHelp: '• Make sure your computer is online\n• Run `happy daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g @yongkangc/happy-coder@latest`',
        daemon: 'Daemon',
        status: 'Status',
